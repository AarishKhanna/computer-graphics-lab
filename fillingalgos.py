...
def Universalfunc():
  ...
  def menu():
       ...
       t=Text(Point(250,50),'YOU CAN IMPLEMENT 3 ALGOS: FIRST OF ALL TYPE FOUR VERTICES IN X Y FASHION')
       g=Text(Point(250,100),'AND THEN TYPE 1 FOR 4-FILL ALGO 2 FOR 8-FILL ALGO AND 3 FOR SCAN-FILL ALGO')
       ...
       for i in range(6):
            ...
            if i == 4:
                ...
                print(x,y,i)
       win.close()
       return text3, text4, vert  

     
  text3, text4, vert = menu()
  print(vert)
